...
50 major urban cities in India with geographical coordinates
"""

INDIAN_CITIES = [
    # Metro Cities (Tier 1)
    {"name": "Mumbai", "state": "Maharashtra", "lat": 19.0760, "lon": 72.8777, "tier": 1},
    {"name": "Delhi", "state": "Delhi", "lat": 28.7041, "lon": 77.1025, "tier": 1},
    ...
    {"name": "Surat", "state": "Gujarat", "lat": 21.1702, "lon": 72.8311, "tier": 1},
    {"name": "Pune", "state": "Maharashtra", "lat": 18.5204, "lon": 73.8567, "tier": 1},
    {"name": "Jaipur", "state": "Rajasthan", "lat": 26.9124, "lon": 75.7873, "tier": 1},
    
    # Tier 2 Cities
    {"name": "Lucknow", "state": "Uttar Pradesh", "lat": 26.8467, "lon": 80.9462, "tier": 2},
    {"name": "Kanpur", "state": "Uttar Pradesh", "lat": 26.4499, "lon": 80.3319, "tier": 2},
    ...
    {"name": "Visakhapatnam", "state": "Andhra Pradesh", "lat": 17.6869, "lon": 83.2185, "tier": 2},
    {"name": "Pimpri-Chinchwad", "state": "Maharashtra", "lat": 18.6298, "lon": 73.7997, "tier": 2},
    {"name": "Patna", "state": "Bihar", "lat": 25.5941, "lon": 85.1376, "tier": 2},
    ...
    {"name": "Nashik", "state": "Maharashtra", "lat": 19.9975, "lon": 73.7898, "tier": 2},
    ...
    {"name": "Kalyan-Dombivli", "state": "Maharashtra", "lat": 19.2403, "lon": 73.1305, "tier": 2},
    {"name": "Vasai-Virar", "state": "Maharashtra", "lat": 19.4612, "lon": 72.7985, "tier": 2},
    {"name": "Varanasi", "state": "Uttar Pradesh", "lat": 25.3176, "lon": 82.9739, "tier": 2},
    {"name": "Srinagar", "state": "Jammu and Kashmir", "lat": 34.0837, "lon": 74.7973, "tier": 2},
    ...
    {"name": "Vijayawada", "state": "Andhra Pradesh", "lat": 16.5062, "lon": 80.6480, "tier": 2},
...
def get_cities_by_tier(tier):
    """Get cities by tier (1 or 2)"""
    return [city for city in INDIAN_CITIES if city['tier'] == tier]

def get_city_count():
    """Return total count of cities"""
